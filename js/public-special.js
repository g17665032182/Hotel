//banner
	...
	var pUl=pics.getElementsByTagName('ul')[0];
	var pLis=pUl.getElementsByTagName('li');
	var timer1=null;
	pUl.innerHTML=pUl.innerHTML+pUl.innerHTML;
	pUl.style.width=pLis[0].offsetWidth*pUl.children.length+'px';
	clearInterval(timer1);
	timer1=setInterval(function(){
		if(pUl.offsetLeft===-1200){
			pUl.style.left=0;
		}else{
			pUl.style.left=pUl.offsetLeft-1+'px';
		}
